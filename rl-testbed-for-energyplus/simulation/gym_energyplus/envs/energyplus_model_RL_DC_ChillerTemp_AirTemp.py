...
class EnergyPlusModelRL_DC_ChillerTemp_AirTemp(EnergyPlusModel):
    def __init__(self, 
        ...
        super(EnergyPlusModelRL_DC_ChillerTemp_AirTemp, self).__init__(model_file, log_dir, verbose)
        ...
        fluct_T_air_sp = 0.0
        self.weight_action_fluctuation = np.array([fluct_T_chill_sp, fluct_T_air_sp])
    ...
    def setup_spaces(self):
        ...
        self.action_space = spaces.Box(
            low=np.array([T_chill_sp_lower_limit, T_air_sp_lower_limit]),
            high=np.array([T_chill_sp_upper_limit, T_air_sp_upper_limit]),
            dtype=np.float64
        )
...
def test_EPlusModel_RL_DC():
    ...
    # Test functions
    ep_model = EnergyPlusModelRL_DC_ChillerTemp_AirTemp(model_file=model_file, log_dir=log_dir)
